...
If no CSV data is available, runs a grid-search style weight optimizer
using game outcomes from repeated matches.
"""
...
# Offensive modes use score_delta_5 as target
# Defensive modes use -invaderDistance + onDefense as proxy target
